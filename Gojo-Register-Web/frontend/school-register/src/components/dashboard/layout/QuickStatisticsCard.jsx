...
export default function QuickStatisticsCard({ myPostsCount, messageCount, totalNotifications }) {
  return (
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 10, alignItems: "center", justifyContent: "center", flexWrap: "nowrap" }}>
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <div style={SMALL_STAT_STYLE}>
            ...
            <div style={VALUE_STYLE}>{myPostsCount}</div>
          </div>
          <div style={SMALL_STAT_STYLE}>
            <div style={LABEL_STYLE}>Unread</div>
            <div style={VALUE_STYLE}>{messageCount}</div>
          </div>
          <div style={SMALL_STAT_STYLE}>
            <div style={LABEL_STYLE}>Notifications</div>
            <div style={VALUE_STYLE}>{totalNotifications}</div>
          </div>
        </div>
      </div>
    </div>
