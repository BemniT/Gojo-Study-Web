...
import { FaSave, FaBell, FaFacebookMessenger } from "react-icons/fa";
import "../styles/global.css";
import RegisterSidebar from "../components/RegisterSidebar";
import ProfileAvatar from "../components/ProfileAvatar";
import useRegistrarSession from "../hooks/auth/useRegistrarSession";
import useStudentRegister from "../hooks/students/useStudentRegister";
...
export default function StudentRegister() {
  ...
  const { admin, schoolCode, DB_ROOT } = useRegistrarSession();
  ...
  const {
    ...
    form, setForm,
    parents, setParents,
    studentPhoto, setStudentPhoto,
    studentNationalIdImage, setStudentNationalIdImage,
    parentProfileFiles, setParentProfileFiles,
    parentNationalIdFiles, setParentNationalIdFiles,
  ...
  const handleChange = (e) => {
    ...
    setForm((prev) => {
      ...
      if (name === "grade") next.section = "";
      if (name === "section") next.section = String(value || "").toUpperCase();
      return next;
    });
  };
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 12 }}>
                          ...
                          <div>
                            ...
                            {gradeOptions.length > 0 ? (
                              ...
                              <input name="grade" value={form.grade} onChange={handleChange} style={fieldStyle} placeholder="Create grades in Grade Management" />
                            )}
                          </div>
                          <div>
                            ...
                            {!form.grade ? (
                              ...
                              <input name="section" value={form.section} onChange={handleChange} style={fieldStyle} placeholder="Add sections in Grade Management" />
                            )}
                          </div>
